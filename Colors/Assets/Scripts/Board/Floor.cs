...
{
    [HideInInspector]
    public TilemapRenderer tilemapRenderer; //There must be a reason to be public...
    public int order{
        get{
    ...
    void Awake(){
        tilemapRenderer = GetComponent<TilemapRenderer>(); //Abreviação de this.transform.GetComponent<TilemapRenderer>()
